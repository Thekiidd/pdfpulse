        ...
        <main className="flex-grow max-w-4xl mx-auto px-4 py-16 text-white">
          <div className="bg-white/5 backdrop-blur-xl p-8 md:p-12 rounded-3xl border border-neon/30 shadow-neon-lg">
            ...
            <div className="prose prose-invert prose-lg max-w-none text-gray-300 space-y-4">
              ...
              <p>
                No recopilamos información de identificación personal (PII) como tu nombre, correo electrónico o dirección. 
                No requerimos registro para usar nuestras herramientas básicas.
              </p>
              
              <h2 className="text-2xl font-bold text-gray-100 pt-4">Manejo de Archivos</h2>
              <p>
                La mayoría de nuestras herramientas (como unir, dividir, rotar) procesan tus archivos 
                directamente en tu navegador. Tus archivos NO se suben a nuestros servidores.
              </p>
              <p>
                Para herramientas avanzadas que requieren procesamiento en el servidor (como "Comprimir PDF" o "Word a PDF" que usan una API), 
                tus archivos se suben temporalmente a un servidor seguro, se procesan y se te entregan para la descarga. 
              ...
              <p>
                Podemos usar cookies para el funcionamiento básico del sitio y para análisis anónimo (como Vercel Analytics o Plausible) 
                para entender cómo se usa nuestro sitio y mejorarlo.
              </p>
              <p>
                Usamos Google AdSense para mostrar anuncios. Google y sus socios pueden usar cookies (como la cookie de DART) 
                para mostrar anuncios basados en tus visitas anteriores a este y otros sitios en Internet. 
                Puedes optar por no usar la cookie de DART visitando la 
                <a href="https://adssettings.google.com/authenticated" target="_blank" rel="noopener noreferrer" className="text-neon hover:underline">Configuración de anuncios de Google</a>.
              </p>
              ...
              <p>
                ...
                contactarnos en: <a href="mailto:hola@pdfpulse.online" className="text-neon hover:underline">hola@pdfpulse.online</a>
              </p>
            </div>
