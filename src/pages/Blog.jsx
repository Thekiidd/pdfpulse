      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="flex-grow max-w-6xl mx-auto px-4 py-24 text-white">
          ...
          {featuredPost && (
            ...
            >
              <article className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-white/5 backdrop-blur-xl border border-neon/30 shadow-neon-lg overflow-hidden transition-all duration-300 hover:border-neon/60">
                <div className="order-2 md:order-1 p-8 md:p-12">
                  <span className="text-sm font-semibold text-neon bg-neon/10 px-3 py-1 mb-4 inline-block">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {otherPosts.map((post) => (
              ...
              >
                <article
                  className="bg-white/5 backdrop-blur-xl border border-neon/30 shadow-neon-lg overflow-hidden
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <span className="text-sm font-semibold text-neon bg-neon/10 px-3 py-1 mb-3 inline-block self-start">
                      {post.category}
                    </span>
          ...
          <div className="mt-16 p-8 bg-white/5 backdrop-blur-xl border border-neon/30 flex flex-col md:flex-row items-center gap-6">
