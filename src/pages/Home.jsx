...
  const ToolComponent = tool.component.type;
  ...
  // ¡Esta línea es la que necesita 'React' importado!
...
          <div className="flex justify-between items-start mb-8">
    ...
      	      </h2>
            {tool.requiresToken ? (
              <span className="flex-shrink-0 ml-4 flex items-center gap-1 bg-neon/10 text-neon text-xs font-bold px-3 py-1 rounded-full">
                <TicketIcon className="w-4 h-4" />
                USA TOKEN
              </span>
            ) : (
              <span className="flex-shrink-0 ml-4 bg-gray-500/20 text-gray-300 text-xs font-bold px-3 py-1 rounded-full">
                GRATIS
              </span>
            )}
          </div>
