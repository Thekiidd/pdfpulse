// src/components/layout/ToolsGrid.jsx
      ...
      {tools.map((tool, i) => {
        ...
        return (
          ...
          >
            {/* Fondo con blur */}
            <div className={`
              absolute inset-0 rounded-2xl bg-black/30 backdrop-blur-xl
            ...
            {!isDisabled && (
              <div className="absolute inset-0 rounded-2xl bg-neon/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
            )}
          </motion.button>
        );
      })}
